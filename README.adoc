...
[cols="52a,48a"]
|===
|image::images/flame_before.svg[flame_before]
...
The "Before" graph is worryingly worse, GC-wise, than the same graph
produced a month ago (as of 2018/08/14). Might be a sign of some
regression in Spring.
